...
import 'package:animal_rescue_application/splash/content_onboarding.dart'; // Assuming this is where `contents` are defined

class Onboarding extends StatefulWidget {
  final String? role; // Optional role parameter to pass to the next screen
